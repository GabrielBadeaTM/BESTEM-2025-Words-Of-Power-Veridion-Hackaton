...
def load_glove_embeddings(filepath):
    print("[*] Se incarca GloVe embeddings...")
    embeddings = {}
    ...
    print(f"[+] S-au incarcat {len(embeddings)} embeddings.\n")
    return embeddings
...
word_to_id = {
    "Sandpaper": 1, "Oil": 2, "Steam": 3, "Acid": 4, "Gust": 5,
    "Boulder": 6, "Drill": 7, "Vacation": 8, "Fire": 9, "Drought": 10,
    "Water": 11, "Vacuum": 12, "Laser": 13, "Life Raft": 14, "Bear Trap": 15,
    "Hydraulic Jack": 16, "Diamond Cage": 17, "Dam": 18, "Sunshine": 19, "Mutation": 20,
    "Kevlar Vest": 21, "Jackhammer": 22, "Signal Jammer": 23, "Grizzly": 24,
    "Reinforced Steel Door": 25, "Bulldozer": 26, "Sonic Boom": 27, "Robot": 28,
    "Glacier": 29, "Love": 30, "Fire Blanket": 31, "Super Glue": 32, "Therapy": 33,
    "Disease": 34, "Fire Extinguisher": 35, "Satellite": 36, "Confidence": 37,
    "Absorption": 38, "Neutralizing Agent": 39, "Freeze": 40, "Encryption": 41,
    "Proof": 42, "Molotov Cocktail": 43, "Rainstorm": 44, "Viral Meme": 45,
    "War": 46, "Dynamite": 47, "Seismic Dampener": 48, "Propaganda": 49,
    "Explosion": 50, "Lightning": 51, "Evacuation": 52, "Flood": 53, "Lava": 54,
    "Reforestation": 55, "Avalanche": 56, "Earthquake": 57, "H-bomb": 58,
    "Dragon": 59, "Innovation": 60, "Hurricane": 61, "Tsunami": 62,
    "Persistence": 63, "Resilience": 64, "Terraforming Device": 65,
    "Anti-Virus Nanocloud": 66, "AI Kill Switch": 67, "Nanobot Swarm": 68,
    "Reality Resynchronizer": 69, "Cataclysm Containment Field": 70,
    "Solar Deflection Array": 71, "Planetary Evacuation Fleet": 72,
    "Antimatter Cannon": 73, "Planetary Defense Shield": 74,
    "Singularity Stabilizer": 75, "Orbital Laser": 76, "Time": 77
}

# ====================== FUNCTIA what_beats ======================
def what_beats(word):
    best_category = classify_tool(word, embeddings, categories_vectors)
    return word_to_id.get(best_category, random.randint(1, 77))
...
print("[*] Se construiesc vectorii pentru categorii...")
categories_vectors = {}
for tool, keywords in tools_categories.items():
    vec = average_vector(keywords, embeddings)
    if vec is not None:
        categories_vectors[tool] = vec
print(f"[+] S-au construit vectorii pentru {len(categories_vectors)} categorii.\n")
